...
'Littérature & Fiction': { 
    'Roman' : ['subject%3A"Fiction"','subject%3A"LITERARY+COLLECTIONS"'],
    'Poésie & théatre' : ['subject%3A"Poetry"','subject%3A"Drama"'],
    'Thriller, Roman Policier' : ['subject%3A"Thriller"','subject%3A"Roman+policier"'],
    'Fantasy, Science Fiction' : ['subject%3A"Fantasy"','subject%3A"science+fiction"']
    },
'Vie Pratique':{
    'Cuisine': ['subject%3A"Cooking"'],
