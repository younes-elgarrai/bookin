  ...
  return(
    ...
    {/* Small Menu */} 
        ...
        <Navbar expand="md" className="menu-nav">
          ...
          <DropdownMenu>
            <DropdownItem><Link to={props.user ? "/main" : "/survey"} className="menu-nav-item-xs"><BulbOutlined className="menu-nav-icon-xs"/> Suggestions</Link></DropdownItem>
            <DropdownItem><Link to={props.user ? "/main" : "/connection"}  className="menu-nav-item-xs"><BookOutlined className="menu-nav-icon-xs" /> Bibliothèque</Link></DropdownItem>
            <DropdownItem><Link to={props.user ? "/library" : "/connection"}  className="menu-nav-item-xs"><HeartOutlined className="menu-nav-icon-xs" /> A lire</Link></DropdownItem>
            {props.user ? 
            <div>
